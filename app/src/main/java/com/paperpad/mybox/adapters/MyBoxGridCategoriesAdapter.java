...
public class MyBoxGridCategoriesAdapter extends BaseAdapter {
	 ...
	 * 
	 */
	public MyBoxGridCategoriesAdapter(List<MyBox> boxs, Context context, Colors colors) {
		this.boxs = boxs;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView==null) {
			...
			convertView  = inflater.inflate(R.layout.mybox_grid_item, parent, false); 
